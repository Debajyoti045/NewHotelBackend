...
// Route 1 : create a user using:  POST "/api/v1/authUser/createuser". Doesnt require Auth
router.post(
  "/createuser",
  //validation checks
  [
...
//Route 2 : Authenticate a user using:  POST "/api/v1/authUser/login". Doesnt require Auth
router.post(
  "/login",
  [body("email").isEmail().withMessage("Please enter a valid email")],
  async (req, res) => {
...
// Route 3 : Get loggedin user details using: POST /api/v1/authUser/getuser. Login required
