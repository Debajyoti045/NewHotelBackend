...
// Route 1 : create a admin using:  POST "/api/v1/authAdmin/createadmin". Doesnt require Auth
router.post(
  "/createadmin",
  //validation checks
  [
...
//Route 2 : Authenticate a admin using:  POST "/api/v1/authAdmin/login". Doesnt require Auth
router.post(
  "/login",
  [body("email").isEmail().withMessage("Please enter a valid email")],
  async (req, res) => {
...
// Route 3 : Get loggedin Admin details using: POST /api/v1/authAdmin/getadmin. Login required
